"""
Random Forest Model Training Script for Building Energy Consumption Prediction
Trains a Random Forest regressor with hyperparameter tuning and saves results
"""
...
def plot_feature_importance(model, feature_names, save_path="outputs/charts/feature_importance_rf.png"):
    """
...
def plot_tree_depth_analysis(model, save_path="outputs/charts/tree_depth_analysis_rf.png"):
    """
...
def save_model_and_predictions(model, y_test_pred, model_path="outputs/model_rf.pkl", 
                             predictions_path="outputs/predictions_rf.csv"):
    """
...
def main():
    ...
    plot_tree_depth_analysis(best_model)
    ...
    print("="*60)
    print("Files saved:")
    print("  - outputs/model_rf.pkl")
    print("  - outputs/predictions_rf.csv") 
    print("  - outputs/charts/feature_importance_rf.png")
    print("  - outputs/charts/tree_depth_analysis_rf.png")
